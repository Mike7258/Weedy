        ...
        <main class="flex-1 p-8 overflow-y-auto">
            <div class="flex justify-between items-center mb-6">
                ...
                <div class="bg-white p-4 rounded-xl border border-gray-200 shadow-sm mb-6">
                    <form action="<?php echo e(url('/admin/Pedidos')); ?>" method="GET" class="flex flex-col md:flex-row gap-4">
                        <!-- Input de Búsqueda -->
                        <div class="flex-1">
                            <div class="relative">
                                ...
                                <input type="text" name="buscar" value="<?php echo e(request('buscar')); ?>" placeholder="Buscar por ID de pedido o Tracking..." class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-weedyGreen focus:border-weedyGreen outline-none text-sm transition">
                            </div>
                        </div>
                        ...
                        <div class="flex space-x-2">
                            ...
                            <?php if(request('buscar') || request('estado')): ?>
                                <a href="<?php echo e(url('/admin/Pedidos')); ?>" class="bg-red-100 hover:bg-red-200 text-red-700 px-4 py-2 rounded-lg text-sm font-semibold transition flex items-center" title="Limpiar filtros">
                    ...
                    <table class="w-full text-sm text-left">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            <?php $__empty_1 = true; $__currentLoopData = $pedidos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pedido): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td class="py-3 font-medium"><?php echo e($pedido->idPedido); ?></td>
                                    <td class="py-3 font-semibold text-gray-900"><?php echo e($pedido->nombre_usuario ?? 'No registrado'); ?></td>
                                    <td class="py-3 text-gray-600"><?php echo e($pedido->cedula_usuario ?? 'N/A'); ?></td>
                                    <td class="py-3 text-gray-600"><?php echo e($pedido->correo_usuario ?? 'N/A'); ?></td>
                                    <td class="py-3 text-gray-600"><?php echo e($pedido->telefono_usuario ?? 'No registrado'); ?></td>
                                    <td class="py-3"><?php echo e($pedido->trackingNumber ?? 'N/A'); ?></td>
                                    <td class="py-3">
                                        <span class="px-2 py-1 bg-gray-100 rounded-full text-xs font-semibold">
                                            <?php echo e($pedido->estadoEnvio ?? 'Pendiente'); ?>

                                        </span>
                                    </td>
                                    <td class="py-3 text-right">
                                        <a href="<?php echo e(url('/admin/ordenes/detalles/' . $pedido->idPedido)); ?>" class="bg-gray-100 hover:bg-gray-200 text-gray-700 px-3 py-1.5 rounded-lg font-medium text-xs transition inline-flex items-center space-x-1">
...
<?php /**PATH /var/www/html/resources/views/admin/pedidos.blade.php ENDPATH**/ ?>