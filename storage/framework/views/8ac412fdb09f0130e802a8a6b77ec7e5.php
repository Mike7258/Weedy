        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
            <div class="flex items-center gap-8">
                ...
                <div class="hidden md:flex space-x-6 text-sm font-bold text-gray-500">
                    <a href="<?php echo e(url('/')); ?>" class="hover:text-weedyRed pb-5 pt-5 transition">Inicio</a>
                    <a href="<?php echo e(url('/tienda')); ?>" class="hover:text-weedyRed pb-5 pt-5 transition">Tienda</a>
                    <a href="<?php echo e(url('/consultas')); ?>" class="text-weedyRed border-b-2 border-weedyRed pb-5 pt-5">Consultas</a>
                </div>
            </div>
            <div class="flex items-center gap-4">
                ...
                <?php if($usuarioLogueado): ?>
                    <div class="flex items-center gap-3">
                        <div class="w-8 h-8 rounded-full bg-weedyGreen text-white flex items-center justify-center font-bold text-sm shadow-inner select-none" title="<?php echo e($nombreCompleto); ?>">
                ...
                <?php else: ?>
                    <a href="<?php echo e(url('/login')); ?>" class="bg-weedyGreen hover:bg-emerald-800 text-white font-bold text-xs px-4 py-2.5 rounded-xl transition shadow-sm">
                        Iniciar Sesión
                    </a>
                <?php endif; ?>
            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <section class="lg:col-span-7">
                ...
                <div id="panel-especialistas" class="space-y-4">
                    <?php if(count($medicos) > 0): ?>
                        <?php $__currentLoopData = $medicos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $medico): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="bg-white border border-gray-200 rounded-2xl p-5 shadow-sm hover:shadow-md transition flex flex-col sm:flex-row justify-between items-center gap-4 card-medico" data-id="<?php echo e($medico->idUsuario); ?>" data-nombre="<?php echo e($medico->nombreCompleto); ?>">
                                <div class="flex gap-4 w-full sm:w-auto">
                                    ...
                                    <div>
                                        <div class="flex items-center gap-2 flex-wrap">
                                            <h4 class="font-extrabold text-weedyDark text-lg tracking-tight"><?php echo e($medico->nombreCompleto); ?></h4>
                                        ...
                                        <p class="text-weedyGreen text-xs font-bold uppercase tracking-wider mt-0.5"><?php echo e($medico->especialidad); ?></p>
                                        <p class="text-gray-400 text-[11px] font-medium mt-1">Licencia Profesional: <span class="text-gray-600 font-mono"><?php echo e($medico->numeroLicencia); ?></span></p>
                                        <p class="text-gray-500 text-xs mt-2.5 flex items-center gap-1.5 font-medium bg-gray-50 px-3 py-2 rounded-xl border border-gray-100 inline-block">
                                            <span>📅</span> <span class="text-gray-600 font-bold">Disponibilidad:</span> <?php echo e($medico->agendaDisponible); ?>
                                ...
                                <div class="shrink-0 w-full sm:w-auto">
                                    ...
                                    <?php else: ?>
                                        <a href="<?php echo e(url('/login')); ?>" class="bg-gray-200 hover:bg-gray-300 text-gray-600 font-bold text-xs px-4 py-2.5 rounded-xl transition shadow-sm w-full text-center block">Ingresa para Agendar</a>
                                    <?php endif; ?>
                                </div>
                            </div>
                ...
                <div id="panel-citas" class="space-y-4 hidden">
                                ...
                                <div class="bg-white border border-gray-200 rounded-2xl p-5 shadow-sm hover:shadow-md transition flex flex-col sm:flex-row justify-between items-center gap-4">
                                    <div class="flex gap-4 w-full sm:w-auto">
                                        <div class="w-14 h-14 rounded-xl bg-gray-50 border border-gray-200 flex flex-col items-center justify-center text-gray-500 shrink-0">
                                            <span class="text-lg font-black text-weedyDark"><?php echo e(date('d', $timestamp)); ?></span>
                                            <span class="text-[9px] font-bold uppercase tracking-wider text-gray-400"><?php echo e(date('M', $timestamp)); ?></span>
                                        </div>
                                        <div>
                                            <h4 class="font-extrabold text-weedyDark text-base tracking-tight">Consulta con <?php echo e($cita->medicoNombre); ?></h4>
                                            <p class="text-weedyGreen text-xs font-bold uppercase tracking-wider mt-0.5"><?php echo e($cita->especialidad); ?></p>
                                            <p class="text-gray-500 text-xs mt-1.5 font-medium">
                                                🕒 Bloque: <span class="text-gray-700 font-bold"><?php echo e($horaFormateada); ?></span> | Estado: 
                                                <span class="px-2 py-0.5 rounded-full text-[9px] font-black uppercase bg-amber-50 text-amber-700 border border-amber-200"><?php echo e($cita->estado); ?></span>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="shrink-0 w-full sm:w-auto">
                                        <a href="<?php echo e($cita->linkVideollamada); ?>" target="_blank" class="bg-weedyDark hover:bg-stone-800 text-white font-bold text-xs px-4 py-2.5 rounded-xl transition shadow-sm w-full text-center inline-block">
                                            🎥 Entrar al Meet
                                        </a>
                                    </div>
                                </div>
                    ...
                    <?php else: ?>
                        <div class="bg-white border border-gray-200 rounded-2xl p-10 text-center text-gray-400 font-medium italic">
                            🔒 Por favor, <a href="<?php echo e(url('/login')); ?>" class="text-weedyGreen font-bold underline">inicia sesión</a> para visualizar tus citas clínicas.
                        </div>
                    <?php endif; ?>
                </div>
            </section>
                ...
                <div class="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm sticky top-24">
                    ...
                    <?php else: ?>
                        <div class="text-center py-6">
                            ...
                            <a href="<?php echo e(url('/login')); ?>" class="w-full inline-block bg-weedyGreen hover:bg-emerald-800 text-white font-black text-xs uppercase tracking-wider py-3 rounded-xl transition text-center shadow-sm">
                                Ir al Login
                            </a>
                        </div>
                    <?php endif; ?>
...
</html><?php /**PATH /var/www/html/resources/views/consultas.blade.php ENDPATH**/ ?>