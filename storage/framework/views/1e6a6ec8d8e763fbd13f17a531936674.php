    ...
    <div class="flex flex-1 overflow-hidden">
        ...
        <aside class="w-64 bg-white border-r border-gray-200 flex flex-col justify-between shrink-0">
            <nav class="p-4 space-y-1">
                ...
                <a href="<?php echo e(url('/admin/inventario')); ?>" class="flex items-center space-x-3 bg-red-100 text-red-800 px-4 py-2.5 rounded-lg text-sm font-semibold">
        ...
        <main class="flex-1 p-8 overflow-y-auto">
            <div class="flex justify-between items-center mb-6">
                ...
                <a href="<?php echo e(url('/admin/inventario/crear')); ?>" class="bg-weedyGreen text-white px-4 py-2 rounded-lg text-sm font-semibold shadow hover:opacity-90 transition">
                    <i class="fa-solid fa-plus mr-1"></i> Agregar Producto
                </a>
            </div>
                    <!-- Barra de Búsqueda y Filtros (Inventario) -->
                    <div class="bg-white p-4 rounded-xl border border-gray-200 shadow-sm mb-6">
                        <form action="<?php echo e(url('/admin/inventario')); ?>" method="GET" class="flex flex-col md:flex-row gap-4">
                            ...
                            <div class="flex-1">
                                <div class="relative">
                                    ...
                                    <input type="text" name="buscar" value="<?php echo e(request('buscar')); ?>" placeholder="Buscar producto por nombre o ID..." class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-weedyGreen focus:border-weedyGreen outline-none text-sm transition">
                                </div>
                            </div>
                            ...
                            <div class="w-full md:w-64">
                                <select name="stock" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-weedyGreen focus:border-weedyGreen outline-none text-sm text-gray-600 transition">
                                    ...
                                    <option value="bajo" <?php echo e(request('stock') == 'bajo' ? 'selected' : ''); ?>>Stock bajo (Menos de 20)</option>
                                    <option value="suficiente" <?php echo e(request('stock') == 'suficiente' ? 'selected' : ''); ?>>Stock suficiente (20 o más)</option>
                                </select>
                            </div>
                            ...
                            <div class="flex space-x-2">
                                ...
                                <?php if(request('buscar') || request('stock')): ?>
                                    <a href="<?php echo e(url('/admin/inventario')); ?>" class="bg-red-100 hover:bg-red-200 text-red-700 px-4 py-2 rounded-lg text-sm font-semibold transition flex items-center" title="Limpiar filtros">
                    ...
                    <table class="w-full text-sm text-left">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            <?php $__empty_1 = true; $__currentLoopData = $productos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prod): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td class="py-3 font-semibold text-gray-600"><?php echo e($prod->id ?? $prod->idProducto ?? 'N/A'); ?></td>
                                    <td class="py-3 font-medium text-gray-900"><?php echo e($prod->nombreProducto ?? $prod->nombre ?? 'Sin nombre'); ?></td>
                                    <td class="py-3">
                                        <span class="px-2.5 py-1 rounded-full text-xs font-semibold <?php echo e(($prod->stockDisponible ?? 0) < 20 ? 'bg-red-100 text-red-700' : 'bg-green-100 text-green-75orka'); ?>">
                                            <?php echo e($prod->stockDisponible ?? 0); ?> unids.
                                        </span>
                                    </td>
                                    <td class="py-3 text-gray-600">$<?php echo e(number_format($prod->precio ?? 0, 2)); ?></td>
                                    <td class="py-3 text-right space-x-2">
                                        <a href="<?php echo e(url('/admin/inventario/editar/' . ($prod->id ?? $prod->idProducto))); ?>" class="text-blue-600 hover:text-blue-900 font-medium">Editar</a>
                                        <a href="<?php echo e(url('/admin/inventario/eliminar/' . ($prod->id ?? $prod->idProducto))); ?>" class="text-red-600 hover:text-red-900 font-medium" onclick="return confirm('¿Estás seguro de eliminar este producto?')">Eliminar</a>
                                    </td>
                                </tr>
...
</html><?php /**PATH /var/www/html/resources/views/admin/inventario.blade.php ENDPATH**/ ?>