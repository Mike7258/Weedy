...
<body class="bg-gray-50 font-sans flex flex-col min-h-screen">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
            <div class="flex items-center gap-8">
                ...
                <div class="hidden md:flex space-x-6 text-sm font-bold text-gray-500">
                    ...
                    <a href="<?php echo e(url('/tienda')); ?>" class="text-weedyRed border-b-2 border-weedyRed pb-5 pt-5">Tienda</a>
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 flex-grow w-full">
        ...
        <div id="panel-pedidos" class="space-y-6 hidden">
                        ...
                        <div class="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm hover:shadow-md transition">
                            <div class="flex flex-col md:flex-row justify-between items-start md:items-center border-b border-gray-100 pb-4 mb-4 gap-2">
                                <div>
                                    ...
                                    <h4 class="font-black text-weedyDark text-lg font-mono"><?php echo e($ped->idPedido); ?></h4>
                                </div>
                                <div class="flex items-center gap-3">
                                    <span class="text-xs font-bold text-gray-500 bg-gray-100 px-3 py-1 rounded-lg">📅 <?php echo e(date('d/m/Y - h:i A', strtotime($ped->updated_at))); ?></span>
                                    <span class="px-3 py-1 rounded-lg text-xs font-black uppercase bg-emerald-50 text-emerald-800 border border-emerald-200">
                                        <?php echo e($ped->estadoEnvio); ?>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
                                <div class="md:col-span-7">
                                    ...
                                    <div class="text-sm font-medium text-gray-700 bg-gray-50 p-3.5 rounded-xl border border-gray-100 leading-relaxed">
                                        <?php echo $ped->productos_detalle; ?>
                                ...
                                <div class="md:col-span-5 space-y-3">
                                    <div>
                                        ...
                                        <p class="text-xs font-bold text-weedyDark mt-0.5">📍 <?php echo e($ped->direccionEntrega); ?></p>
                                    </div>

                                    <div>
                                        <span class="text-xs font-bold text-gray-400 uppercase tracking-wide block">Número de Tracking</span>
                                        <p class="text-xs font-mono font-bold text-weedyGreen">🚚 <?php echo e($ped->trackingNumber); ?></p>
                                    </div>

                                    <?php if(!empty($ped->notas)): ?>
                                        <div>
                                            <span class="text-xs font-bold text-gray-400 uppercase tracking-wide block">Método de Pago</span>
                                            <p class="text-[11px] font-semibold text-gray-500">💳 <?php echo e($ped->notas); ?></p>
                                        </div>
                                    <?php endif; ?>
                                    ...
                                    <div class="border-t border-gray-100 pt-2 flex justify-between items-center">
                                        ...
                                        <span class="text-xl font-black text-weedyDark">$<?php echo e(number_format($ped->total_pedido, 2)); ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <?php else: ?>
                <div class="bg-white border border-gray-200 rounded-2xl p-12 text-center text-gray-400 font-medium italic">
                    🔒 Por favor, <a href="<?php echo e(url('/login')); ?>" class="text-weedyGreen font-bold underline">inicia sesión</a> para consultar el historial de tus pedidos.
                </div>
            <?php endif; ?>
        </div>
    ...
    <div id="modal-carrito" class="fixed inset-0 bg-black/50 z-50 flex justify-end hidden transition-opacity">
        <div class="bg-white w-full max-w-md h-full shadow-2xl p-6 flex flex-col justify-between overflow-y-auto">
            ...
            <div class="border-t border-gray-100 pt-4 mt-auto">
                ...
                <?php else: ?>
                    <a href="<?php echo e(url('/login')); ?>" class="w-full bg-gray-200 hover:bg-gray-300 text-gray-700 font-bold text-xs uppercase tracking-wider py-3 rounded-xl transition shadow-sm text-center block">
    ...
    <script>
        ...
        function procesarCompra() {
            ...
            fetch("<?php echo e(url('/procesar-pedido')); ?>", { 
                method: 'POST', 
                headers: {
        ...
        function actualizarCatalogo() {
            ...
            temporizadorFiltro = setTimeout(() => {
                ...
                fetch("<?php echo e(url('/filtrar-productos')); ?>", { 
                    method: 'POST', 
                    headers: {
                        'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
                    },
...
</html><?php /**PATH /var/www/html/resources/views/tienda.blade.php ENDPATH**/ ?>