    ...
    <div class="flex flex-1 overflow-hidden">
        ...
        <main class="flex-1 p-8 overflow-y-auto">
            <div class="flex justify-between items-center mb-6">
                ...
                <a href="<?php echo e(url('/admin/empleados/nuevo')); ?>" class="bg-weedyRed hover:bg-red-700 text-white px-4 py-2 rounded-lg font-medium text-sm transition flex items-center space-x-2">
            ...
            <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-4 mb-6">
                <form action="<?php echo e(url('/admin/empleados')); ?>" method="GET" class="flex flex-col md:flex-row gap-4">
                    ...
                    <div class="flex-1 relative">
                        ...
                        <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Buscar por nombre, cédula o correo..." 
                    ...
                    <div class="w-full md:w-64">
                        <select name="rol" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-weedyRed focus:border-weedyRed text-gray-700 bg-white">
                            ...
                            <option value="Gestor" <?php echo e(request('rol') == 'Gestor' ? 'selected' : ''); ?>>Gestor</option>
                            <option value="Doctor" <?php echo e(request('rol') == 'Doctor' ? 'selected' : ''); ?>>Doctor</option>
                        </select>
                    </div>
                    ...
                    <div class="flex space-x-2">
                        ...
                        <?php if(request()->has('search') || request()->has('rol')): ?>
                            <a href="<?php echo e(url('/admin/empleados')); ?>" class="bg-gray-100 hover:bg-gray-200 text-gray-600 px-4 py-2 rounded-lg text-sm font-medium transition flex items-center">
                                Limpiar
                            </a>
                        <?php endif; ?>
                    </div>
                    ...
                    <table class="w-full text-sm text-left">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            <?php $__empty_1 = true; $__currentLoopData = $empleados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $empleado): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td class="py-4 font-medium"><?php echo e($empleado->idUsuario); ?></td>
                                    <td class="py-4 font-semibold text-gray-900"><?php echo e($empleado->nombreCompleto ?? 'N/A'); ?></td>
                                    <td class="py-4">
                                        ...
                                        <?php elseif($empleado->rol == 'Doctor'): ?>
                                            <span class="bg-blue-100 text-blue-800 px-2.5 py-1 rounded-md text-xs font-semibold">Doctor</span>
                                        <?php elseif($empleado->rol == 'Gestor'): ?>
                                            <span class="bg-orange-100 text-orange-800 px-2.5 py-1 rounded-md text-xs font-semibold">Gestor</span>
                                        <?php else: ?>
                                            <span class="bg-gray-100 text-gray-800 px-2.5 py-1 rounded-md text-xs font-semibold"><?php echo e($empleado->rol ?? 'Sin rol'); ?></span>
                                        <?php endif; ?>
                                    </td>
                                    <td class="py-4 text-gray-600"><?php echo e($empleado->correoElectronico ?? 'N/A'); ?></td>
                                    <td class="py-4 text-gray-600"><?php echo e($empleado->telefono ?? 'No registrado'); ?></td>
                                    <td class="py-4 text-right flex justify-end space-x-2">
                                        
                                        <!-- Botón Editar -->
                                        <a href="<?php echo e(url('/admin/empleados/editar/' . $empleado->idUsuario)); ?>" class="text-blue-600 hover:text-weedyGreen transition p-1">
                                            <i class="fa-solid fa-pen"></i>
                                            <span>Editar</span>
                                        </a>

                                        <!-- Botón Borrar -->
                                        <form action="<?php echo e(url('/admin/empleados/eliminar/' . $empleado->idUsuario)); ?>" method="POST" onsubmit="return confirm('¿Estás seguro de que deseas eliminar este empleado?');" class="inline-block">
                                            <?php echo csrf_field(); ?>
...
</html><?php /**PATH /var/www/html/resources/views/admin/empleados.blade.php ENDPATH**/ ?>