    ...
    <div class="flex flex-1 overflow-hidden">
        ...
        <aside class="w-64 bg-white border-r border-gray-200 flex flex-col justify-between shrink-0">
            <nav class="p-4 space-y-1">
                ...
                <a href="<?php echo e(url('/admin/Pedidos')); ?>" class="flex items-center space-x-3 bg-red-100 text-red-800 px-4 py-2.5 rounded-lg text-sm font-semibold">
        ...
        <main class="flex-1 p-8 overflow-y-auto">
            ...
            <div class="flex items-center justify-between mb-6">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">Detalles del pedido <?php echo e($pedido->idPedido); ?></h1>
                    <p class="text-sm text-gray-500 mt-1">Modifica la información del envío o añade notas de seguimiento.</p>
                </div>
                <a href="<?php echo e(url('/admin/Pedidos')); ?>" class="bg-gray-200 hover:bg-gray-300 text-gray-700 px-4 py-2 rounded-lg text-sm font-semibold transition flex items-center space-x-2">
            ...
            <form action="<?php echo e(url('/admin/pedidos/actualizar/' . $pedido->idPedido)); ?>" method="POST" class="bg-white rounded-xl border border-gray-200 shadow-sm max-w-4xl overflow-hidden">
                <?php echo csrf_field(); ?>
                <?php echo method_field('PUT'); ?> <!-- O POST según definas en tu ruta -->
                ...
                <div class="bg-gray-50 px-6 py-4 border-b border-gray-200 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <span class="font-bold text-gray-700 text-base">ID de Pedido: <?php echo e($pedido->idPedido); ?></span>
                    <div class="flex items-center space-x-2">
                        ...
                        <select name="estadoEnvio" class="px-3 py-1 bg-white border border-gray-300 rounded-lg text-xs font-semibold text-gray-700 focus:ring-weedyGreen focus:border-weedyGreen outline-none">
                            <option value="Pendiente" <?php echo e(($pedido->estadoEnvio ?? '') == 'Pendiente' ? 'selected' : ''); ?>>Pendiente</option>
                            <option value="Confirmado" <?php echo e(($pedido->estadoEnvio ?? '') == 'Confirmado' ? 'selected' : ''); ?>>Confirmado</option>
                            <option value="Rechazado" <?php echo e(($pedido->estadoEnvio ?? '') == 'Rechazado' ? 'selected' : ''); ?>>Rechazado</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                            <div class="bg-gray-50 p-3 rounded-lg border border-gray-100">
                                ...
                                <span class="text-sm font-semibold text-gray-800"><?php echo e($pedido->nombre_usuario ?? 'No registrado'); ?></span>
                            </div>
                            <div class="bg-gray-50 p-3 rounded-lg border border-gray-100">
                                <span class="text-xs text-gray-400 block">Cédula</span>
                                <span class="text-sm font-semibold text-gray-800"><?php echo e($pedido->cedula_usuario ?? 'N/A'); ?></span>
                            </div>
                            <div class="bg-gray-50 p-3 rounded-lg border border-gray-100">
                                <span class="text-xs text-gray-400 block">Teléfono</span>
                                <span class="text-sm font-semibold text-gray-800"><?php echo e($pedido->telefono_usuario ?? 'No registrado'); ?></span>
                            </div>
                            <div class="bg-gray-50 p-3 rounded-lg border border-gray-100">
                                <span class="text-xs text-gray-400 block">Fecha del Pedido</span>
                                <span class="text-sm font-semibold text-gray-800"><?php echo e($pedido->created_at ?? 'No registrada'); ?></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="trackingNumber" value="<?php echo e($pedido->trackingNumber); ?>" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-weedyGreen focus:border-weedyGreen outline-none text-sm transition">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" value="<?php echo e($pedido->idRecipe ?? 'N/A'); ?>" disabled class="w-full px-4 py-2 bg-gray-100 border border-gray-200 rounded-lg text-sm text-gray-500 cursor-not-allowed">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="direccionEntrega" rows="2" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-weedyGreen focus:border-weedyGreen outline-none text-sm transition"><?php echo e($pedido->direccionEntrega); ?></textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="notas" rows="3" placeholder="Añadir notas internas o instrucciones especiales para este envío..." class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-weedyGreen focus:border-weedyGreen outline-none text-sm transition"><?php echo e($pedido->notas ?? ''); ?></textarea>
                    </div>
...
</html><?php /**PATH /var/www/html/resources/views/admin/ordenes_detalles.blade.php ENDPATH**/ ?>