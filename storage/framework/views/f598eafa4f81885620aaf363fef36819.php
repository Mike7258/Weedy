...
<head>
    ...
    <title>Weedy - Añadir Empleado</title>
    ...
    <div class="flex flex-1 overflow-hidden">
        ...
        <main class="flex-1 p-8 overflow-y-auto">
            ...
            <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-8 max-w-4xl">
                ...
                <form action="<?php echo e(url('/admin/empleados/guardar')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">ID de Usuario (Ej: EMP-002)</label>
                                <input type="text" name="idUsuario" required value="<?php echo e(old('idUsuario')); ?>" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-weedyRed focus:border-weedyRed focus:outline-none transition">
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Nombre Completo</label>
                                <input type="text" name="nombreCompleto" required value="<?php echo e(old('nombreCompleto')); ?>" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-weedyRed focus:border-weedyRed focus:outline-none transition">
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Cédula de Identidad</label>
                                <input type="text" name="cedulaIdentidad" required value="<?php echo e(old('cedulaIdentidad')); ?>" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-weedyRed focus:border-weedyRed focus:outline-none transition">
                            </div>
                        </div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="email" name="correoElectronico" required value="<?php echo e(old('correoElectronico')); ?>" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-weedyRed focus:border-weedyRed focus:outline-none transition">
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Teléfono</label>
                                <input type="text" name="telefono" value="<?php echo e(old('telefono')); ?>" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-weedyRed focus:border-weedyRed focus:outline-none transition">
                            </div>
                            ...
                            <div>
                                ...
                                <select name="rol" required class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-weedyRed focus:border-weedyRed focus:outline-none transition bg-white text-gray-700">
                                    <option value="" disabled <?php echo e(old('rol') ? '' : 'selected'); ?>>Selecciona un rol...</option>
                                    <option value="Administrador" <?php echo e(old('rol') == 'Administrador' ? 'selected' : ''); ?>>Administrador</option>
                                    <option value="Gestor" <?php echo e(old('rol') == 'Gestor' ? 'selected' : ''); ?>>Gestor</option>
                                    <option value="Doctor" <?php echo e(old('rol') == 'Doctor' ? 'selected' : ''); ?>>Doctor</option>
                                </select>
                            </div>
                        </div>
                    </div>
...
</html><?php /**PATH /var/www/html/resources/views/admin/empleados_crear.blade.php ENDPATH**/ ?>