    ...
    <div class="flex flex-1 overflow-hidden">
        ...
        <aside class="w-64 bg-white border-r border-gray-200 flex flex-col justify-between shrink-0">
            <nav class="p-4 space-y-1">
                ...
                <div class="pt-4 mt-4 border-t border-gray-100">
                    ...
                    <a href="<?php echo e(url('/admin/empleados')); ?>" class="flex items-center space-x-3 bg-red-100 text-red-800 px-4 py-2.5 rounded-lg text-sm font-semibold">
        ...
        <main class="flex-1 p-8 overflow-y-auto">
            <div class="flex items-center space-x-4 mb-6">
                <a href="<?php echo e(url('/admin/empleados')); ?>" class="text-gray-400 hover:text-weedyRed transition">
            ...
            <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-8 max-w-4xl">
                ...
                <form action="<?php echo e(url('/admin/empleados/actualizar/' . $empleado->idUsuario)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="idUsuario" readonly value="<?php echo e($empleado->idUsuario); ?>" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm bg-gray-100 text-gray-500 cursor-not-allowed">
                                <p class="text-xs text-gray-400 mt-1">El ID de usuario no se puede modificar.</p>
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Nombre Completo</label>
                                <input type="text" name="nombreCompleto" required value="<?php echo e(old('nombreCompleto', $empleado->nombreCompleto)); ?>" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-weedyRed focus:border-weedyRed focus:outline-none transition">
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Cédula de Identidad</label>
                                <input type="text" name="cedulaIdentidad" required value="<?php echo e(old('cedulaIdentidad', $empleado->cedulaIdentidad)); ?>" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-weedyRed focus:border-weedyRed focus:outline-none transition">
                            </div>
                        </div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="email" name="correoElectronico" required value="<?php echo e(old('correoElectronico', $empleado->correoElectronico)); ?>" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-weedyRed focus:border-weedyRed focus:outline-none transition">
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Teléfono</label>
                                <input type="text" name="telefono" value="<?php echo e(old('telefono', $empleado->telefono)); ?>" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-weedyRed focus:border-weedyRed focus:outline-none transition">
                            </div>
                            ...
                            <div>
                                ...
                                <select name="rol" required class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-weedyRed focus:border-weedyRed focus:outline-none transition bg-white text-gray-700">
                                    <option value="Administrador" <?php echo e((old('rol', $empleado->rol) == 'Administrador') ? 'selected' : ''); ?>>Administrador</option>
                                    <option value="Gestor" <?php echo e((old('rol', $empleado->rol) == 'Gestor') ? 'selected' : ''); ?>>Gestor</option>
                                    <option value="Doctor" <?php echo e((old('rol', $empleado->rol) == 'Doctor') ? 'selected' : ''); ?>>Doctor</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex justify-end space-x-3 pt-6 border-t border-gray-100">
                        <a href="<?php echo e(url('/admin/empleados')); ?>" class="bg-gray-100 hover:bg-gray-200 text-gray-700 px-5 py-2.5 rounded-lg text-sm font-medium transition">
                            Cancelar
                        </a>
...
</html><?php /**PATH /var/www/html/resources/views/admin/empleados_editar.blade.php ENDPATH**/ ?>