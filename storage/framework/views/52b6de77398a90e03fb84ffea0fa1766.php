                    ...
                    <table class="w-full text-sm text-left">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            <?php $__empty_1 = true; $__currentLoopData = $pacientes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $paciente): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td class="py-3 font-medium"><?php echo e($paciente->idUsuario); ?></td>
                                    <td class="py-3 font-semibold text-gray-900"><?php echo e($paciente->nombreCompleto ?? 'N/A'); ?></td>
                                    <td class="py-3 text-gray-600"><?php echo e($paciente->cedulaIdentidad ?? 'N/A'); ?></td>
                                    <td class="py-3 text-gray-600"><?php echo e($paciente->correoElectronico ?? 'N/A'); ?></td>
                                    <td class="py-3 text-gray-600"><?php echo e($paciente->telefono ?? 'No registrado'); ?></td>
                                    <td class="py-3 text-right">
                                        <a href="<?php echo e(url('/admin/pacientes/editar/' . $paciente->idUsuario)); ?>" class="bg-blue-50 hover:bg-blue-100 text-blue-700 px-3 py-1.5 rounded-lg font-medium text-xs transition inline-flex items-center space-x-1">
                                            <i class="fa-solid fa-pen"></i>
                                            <span>Editar</span>
                                        </a>

                                        <!-- Botón Borrar (con formulario y confirmación) -->
                                        <form action="<?php echo e(url('/admin/pacientes/eliminar/' . $paciente->idUsuario)); ?>" method="POST" onsubmit="return confirm('¿Estás seguro de que deseas eliminar este paciente? Esta acción no se puede deshacer.');" class="inline-block">
                                            <?php echo csrf_field(); ?>
...
</html><?php /**PATH /var/www/html/resources/views/admin/pacientes.blade.php ENDPATH**/ ?>